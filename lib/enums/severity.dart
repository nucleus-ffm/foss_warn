...
enum Severity {
  ...
  String getLocalizedName(BuildContext context) {
    ...
    return switch (this) {
      minor =>
        localizations.warning_severity_minor, //@todo use warning_severity_minor
      moderate => localizations
          .warning_severity_moderate, //@todo use warning_severity_moderate
      severe =>
        localizations.warning_severity_severe, // warning_severity_severe
      extreme =>
        localizations.warning_severity_extreme, //warning_severity_extreme
      unknown =>
        localizations.warning_severity_unknown, //warning_severity_unknown
    };
  }
