    ...
    return ListTile(
      ...
      title: Row(
        ...
        children: [
          ...
          SourceCanBeDisabled(widget.notificationPreferences.warningSource)
              ? Switch(
                  value: widget.notificationPreferences.notificationLevel !=
                              ...
                              setState(
                                () {
                                  ...
                                  widget.notificationPreferences
                                          .notificationLevel =
                                      getNotificationPreferencesForValue(value);
                                },
                              );
                            },
                            onChangeEnd: (value) {
