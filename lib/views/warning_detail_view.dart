...
class _DetailScreenState extends ConsumerState<DetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> onSharePressed() async {
      ...
      var shareSubject = warning.info[0].headline;
        ...
        Wrap(
          children: [
            _TagButton(
              ...
              info: translateWarningCategory(
                alert.info[0].event,
                context,
              ),
            ),
            _TagButton(
              color: chooseWarningTypeColor(alert.messageType),
